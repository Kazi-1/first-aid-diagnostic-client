...
const useFirebase = () => {
    ...
    // Observer of user state (observing whether a user login or logout)
    useEffect(() => {
    ...
    useEffect(() => {
        fetch(`https://floating-wave-78115.herokuapp.com/users/${user.email}`)
        .then(res=> res.json())
    ...
    const saveUser = (email, displayName, method) => {
        ...
        fetch('https://floating-wave-78115.herokuapp.com/users', {
            method: method,
            headers: {
